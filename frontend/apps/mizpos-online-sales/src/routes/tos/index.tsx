  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          この利用規約（以下，「本規約」といいます。）は，MIZPOS運営者（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        ...
        >
          ...
          <li>
            本契約に関する一切の紛争（裁判所の調停手続きを含む）は、訴額に応じて川崎簡易裁判所または横浜地方裁判所を第一審の専属的合意管轄裁判所とすることに合意する。
          </li>
        </ol>
      ...
      >
        ...
        >
          この利用規約（以下，「本規約」といいます。）は，MIZPOS運営者（以下，「運営者」といいます。）がこのウェブサイト上で提供するWEB販売サービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。なお、本規定は主たる利用規約のうちWEB販売サービスにのみ適用される個別規約に該当します。
        </p>
        ...
        >
          <li>
            本規約は，ユーザーと運営者との間の本サービスの利用に関し、特にお客様との金銭やり取りが生じる場合（オンラインショップでの購入、アドバイザリーサービスに関する契約等）に適用されるものとします。
          </li>
          <li>
            本規約のほか、別に契約書に基づいて運営者が提供するサービスに関しては、その契約書の内容が優先されるものとします。
          </li>
        </ol>
        ...
        >
          本サービスによって提供される商品写真その他のコンテンツ（以下「コンテンツ」といいます）の著作権又はその他の知的所有権は,運営者及びコンテンツ提供者などの正当な権利者に帰属し,ユーザーは,これらを無断で複製,転載,改変,その他の二次利用をすることはできません。
        </p>
        ...
        >
          <li>
            運営者は，以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。
            <ol
              className={css({
                paddingLeft: "20px",
                marginTop: "10px",
            ...
            >
              <li>
                利用規約、本規約（WEB販売サービス規約）およびその他の個別規約のいずれかの条項に違反した場合
              </li>
              <li>登録事項に虚偽の事実があることが判明した場合</li>
              <li>
